...
class EfsList {
    constructor(instance_id='i-elliott-learns-js') {
        this.instance_id = instance_id;
        this.mount = "sudo mount -t nfs4 -o nfsvers=4..../ /mnt/"
    }        
    ...
    async list_efs_share(cmd)  {
            ...
            const results = setTimeout(() =>  this.get_command_exec_results(data.Command.CommandId), \
                                       10000);               
